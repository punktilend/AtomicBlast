# AtomicBlast — Codex Notes

Running notes for Codex sessions. Covers architecture, known gotchas, and
...
A Codex PostToolUse hook is configured in
`.Codex/settings.local.json` (project root). Any time Codex edits a file
